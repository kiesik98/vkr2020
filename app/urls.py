...
from accounts.views import login_view, logout_view, signup_view, generate_view, results_analitics_view, delete
...
auth_patterns = [
    ...
    path('delete', delete, name='generate'),
    path('results_analitics/<pk>', results_analitics_view, name='results_analitics')
]
